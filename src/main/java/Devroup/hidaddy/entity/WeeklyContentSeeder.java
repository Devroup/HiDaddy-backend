...
public class WeeklyContentSeeder {
    ...
    public void seedWeeklyContent() {
        if (weeklyContentRepository.count() == 0) { // 중복 삽입 방지
            WeeklyContent week1 = WeeklyContent.builder()
                    .week(1)
                    .title("1주차")
                    .content("""
                            ### 아기는 이렇게 자라고 있어요

                            우리 아기는 지금, 단 하나의 세포로 시작되는 기적을 겪고 있어요.
                            ...
                            이 시기는 아직 병원에서 특별한 검사를 받을 필요는 없어요.
                ...
                WeeklyContent week2 = WeeklyContent.builder()
                    .week(2)
                    .title("2주차")
                    .content("""
                            ### 아기는 이렇게 자라고 있어요

                            이제 막 생명을 틔운 아기는, 아직 '태아(胎兒)'가 아닌 '태아(胎芽)'라고 불려요.
                            ...
                            이 시기에도 엄마의 몸은 겉으론 큰 변화가 없어 보일 수 있어요.
                            ...
                            아직 병원에 갈 단계는 아니지만, 집에서 임신진단 시약으로 확인해볼 수 있어요.
            ...
            weeklyContentRepository.saveAll(List.of(week1, week2));
        }
    }
}
